...
class Datatransformation:
    ...
    def get_data_transformer_objject(self):
         try:
             ...
             num_pipeline = Pipeline( # This pipeline runs on the training dataset
                 steps=[
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            preprocessing_obj = self.get_data_transformer_objject()
